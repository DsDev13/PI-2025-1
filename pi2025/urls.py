"""
URL configuration for pi2025 project.
...
urlpatterns = [
    ...
    path('cadastro/', views.registrar_usuario, name='cadastro'),  # Cadastro de usuário
    path('accounts/', include('django.contrib.auth.urls')),  # Login e logout
